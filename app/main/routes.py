...
from .api.v1 import auth_routes, daily_payment_routes, order_routes, tracking_routes, payment_routes, cancellation_routes, return_routes
...
bp.register_blueprint(daily_payment_routes.bp, url_prefix='/api/v1')